...
class ReportCertificate(models.Model):
    ...
    keyword = fields.Char(
        string='Signature Area Keyword', 
        help="Keyword to determine the coordinates to put digital signature")
    signature_width = fields.Integer(
        string='Signature Width',
        default=110,
        help="Signature Width")
    signature_height = fields.Integer(
    ...
    counter_sign = fields.Char('Counter Sign Field')
