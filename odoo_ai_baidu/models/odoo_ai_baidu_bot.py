...
class OdooAiBaiduBot(models.Model):
    _name = 'odoo.ai.baidu.bot'
    _description = 'Odoo AI - Baidu ERNIE Bot'


    def _apply_logic(self, record, values):
        ai_bot_id = self.env['ir.model.data'].xmlid_to_res_id('odoo_ai_baidu.partner_ai')
